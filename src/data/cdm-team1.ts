  ...
  children: [
    {
      ...
      title: '主任助理',
      children: [
        { name: '贾潘丽', title: '临床数据管理经理' },
        { name: '李元晶', title: '助理临床数据管理经理' },
        { name: '丁福洋', title: '助理临床数据管理经理' },
      ],
    },
    {
      name: '杨俐娴',
      title: '主任助理',
      children: [
        { name: '史庆秀', title: '助理临床数据管理经理' },
        { name: '曹郡颖', title: '助理临床数据管理经理' },
      ],
    },
    {
      name: '谢庭益',
      title: '临床数据管理经理',
      children: [
        { name: '俞婷', title: '助理临床数据管理经理' },
        { name: '李倩楠', title: '临床数据管理员' },
      ],
    },
    {
      name: '陈帆',
      title: '临床数据管理经理',
      children: [
        { name: '徐燕', title: '临床数据管理经理' },
        { name: '屠乐琪', title: '助理临床数据管理经理' },
      ],
    },
    {
      name: '王今歌',
      title: '资深临床数据管理经理',
      children: [
        { name: '陈宇洁', title: '临床数据管理经理' },
        { name: '王宇嘉', title: '助理临床数据管理经理' },
        { name: '朱心蓓', title: '助理临床数据管理经理' },
      ],
    },
  ],
}
