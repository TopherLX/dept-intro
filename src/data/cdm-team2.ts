import type { Member, Topic, Training, TeamIntro, Responsibility, Showcase, HeroData, OrgNode, WorkingGroup } from './types'
...
export const hero: HeroData = {
  ...
  image: `${import.meta.env.BASE_URL}hero/cdm-team2.svg`,
}
...
export const responsibilities: Responsibility[] = [
  {
    ...
    title: '数据质量全生命周期管理',
    description:
      '负责临床试验数据质量全生命周期管理，聚焦关键数据与关键流程：包括主要终点/次要终点、入排标准、疗效指标、安全性数据、重要方案偏离、关键流程合规性等。',
    color: '#8B5CF6',
  },
  {
    icon: '🔍',
    title: '数据质量风险识别与分析',
    description:
      '开展数据质量风险信号识别与分析：数据完整性与一致性分析、逻辑异常识别、质疑管理分析、数据管理报告等，识别数据质量系统性问题，推动根本原因分析（RCA）与整改闭环。',
    color: '#F472B6',
  },
  {
    icon: '🤝',
    title: '跨职能协同与沟通',
    description:
      '开展跨职能协同与沟通，定期向运营、医学、统计团队汇报数据质量发现，与临床质量保证部门持续对接，对系统性/高风险问题推动中心稽查与源数据质控。',
    color: '#34D399',
  },
]
...
export const workingGroups: WorkingGroup[] = [
  {
    ...
    name: 'QC 小组',
    description:
      '创建数据管理质控流程并常态化开展工作合规校验，确保各项数据管理动作严格对标 SOP，守住流程合规底线；集中排查共性、批量问题，精准定位日常工作中的薄弱环节，实现问题早发现、早整改；反向输出优化建议，驱动 SOP 迭代完善，形成 “执行 - 质控 - 优化” 的良性闭环。',
    color: '#FBBF24',
  },
  {
    icon: '📋',
    name: 'CRF 标准库小组',
    description:
      '严格对标 CDISC 行业标准，落地 CRF 全维度标准化建设，从源头满足合规要求、保障数据质量，有效降低核查与递交风险。深度践行 QbD 理念，依托标准库实现模板、字段、逻辑、布局统一，消除人为差异，保障各项目 CRF 设计质量稳定一致。为公司顺利完成 NMPA、FDA 等国内外药监数据递交工作筑牢质量根基。',
    color: '#8B5CF6',
  },
  {
    icon: '🔧',
    name: 'DVS 标准化小组',
    description:
      '致力于 DVS 全流程标准化管理，保障部门整体项目数据质量的一致和可控；与技术团队合作开发 EC 标准库管理平台和 DRS 线上管理平台，从核查逻辑撰写、审核、发布到落地实现高效流程和质量管理；核查逻辑标准化将减少重复配置与临时规则梳理工作，大幅提升数据核查、质疑管理的整体工作效率和质量。',
    color: '#34D399',
  },
]
